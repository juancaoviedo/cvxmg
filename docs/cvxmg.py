...
class DeterministicDSMS():                                  
    ...
    **prob_info:** (dictionary) 
    Contains the information related to the configuration of the optimization formulation. To make easier setting the parameters, a function named variables is created to import the values of problem info from a *.csv file. Additionally, prob_info should include the weather conditions of the geographical region where the IMG is going to be installed. To make easier the process of importing these data, resources_norm, resources_all and resources_noise functions were created.
    

    .. tip::
        For more information about how to create the variable prob_info please refer to Setting prob_info section. 
        For more information about the different options of how to generate the scenarios for the multiyear analysis, please refer to resources_norm, resources_all and resources_noise.  
    ...
    **sources_info:** (dictionary) 
    ...
    .. tip::
        Please refer to **Setting sources_info** section. 
    '''
...
class YearlySolverDSMS():                                   
    '''
    | Solver created for the multiyear analysis. This solver computes the results of one year of operation of the microgrid. The yearly solver requires the following parameters:
...
class MultiyearDSMS():                                      
    '''
    |Multiyear constructor to ensamble the microgrid using Demand Side Management Strategies. The multiyear constructor implements the adaptative method described in [pece2019]_. However, the multiyear analysis here does not consider three day each month as the authors propose in the article. The multy-year analysis here considers the full year analysis (8760 hours).
    |The multiyear constructor requires the following parameters:
...
class EStorage():                       
    ...
    | Installed capacity in the previous year. This attribute only works for multiyear analysis. The default value is zero. 
